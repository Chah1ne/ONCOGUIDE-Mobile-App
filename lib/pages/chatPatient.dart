...
class ChatPatientPage extends StatefulWidget {
  @override
  _ChatPatientPageState createState() => _ChatPatientPageState();
}
...
class UserTile extends StatelessWidget {
  ...
  UserTile(
      {required this.userEmail, required this.lastMessage, required this.onTap});
